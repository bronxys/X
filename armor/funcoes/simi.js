const fs = require('fs');
const simih = JSON.parse(fs.readFileSync('./DADOS/usuarios/grupos/simi.json'));
...
fs.writeFileSync('./DADOS/usuarios/grupos/simi.json', JSON.stringify(simih, null, 4))
