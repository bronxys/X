...
const makeSocket = (config) => {
    ...
    const sendRawMessage = async (data) => {
        ...
        await (0, Utils_1.promiseTimeout)(connectTimeoutMs, async (resolve) => {
            try {
    ...
    const getAvailablePreKeysOnServer = async () => {
        ...
        try {
            ...
            if (!((_a = countChild === null || countChild === void 0 ? void 0 : countChild.attrs) === null || _a === void 0 ? void 0 : _a.value)) {
    ...
    const uploadPreKeysToServerIfRequired = async () => {
        const preKeyCount = await getAvailablePreKeysOnServer();
        logger.info(`${preKeyCount} pre-keys found on server`);
        if (preKeyCount && preKeyCount <= Defaults_1.MIN_PREKEY_COUNT) {
            await uploadPreKeys();
        }
    };
    ...
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        ...
        authState.creds.pairingCode = pairingCode === null || pairingCode === void 0 ? void 0 : pairingCode.toUpperCase();
        authState.creds.me = {
